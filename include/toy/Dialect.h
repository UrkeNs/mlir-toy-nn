...
class ModelType : public mlir::Type::TypeBase<ModelType, mlir::Type, mlir::TypeStorage> {
  public:
    using Base::Base;
  
    static constexpr llvm::StringLiteral name = "toy.model";
  
    static ModelType get(mlir::MLIRContext *ctx) { return Base::get(ctx); }
  };
